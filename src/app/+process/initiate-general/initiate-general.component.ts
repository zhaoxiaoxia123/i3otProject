...
@Component({
  selector: 'app-initiate-general',
  templateUrl: './initiate-general.component.html',
  encapsulation: ViewEncapsulation.None, //在于不让angular4样式生效
  styleUrls: ['./initiate-general.scss']
})
export class InitiateGeneralComponent implements OnInit {
  ...
  uid : any = 0;
  cid : any = 0;
  type : number = 5; //审批类型 通用审批
  approval_or_copy : string = '';
  domain_url : any = '';
  url : string = this.globalService.getDomain();
  rollback_url : string = '/process/initiate-goout';
  constructor(
      private http:Http,
