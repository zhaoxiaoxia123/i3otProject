...
export class SalesListComponent implements OnInit {
  ...
  editPurchase(){
    ...
    this.router.navigate(['/sales-management/add-sales/'+id]);
  }
  ...
  deletePurchase(){
    ...
    msg = '您确定要删除该信息吗？';
    if(confirm(msg)) {
      let url = this.globalService.getDomain()+'/api/v1/deletePurchaseById?pr_id=' + ids + '&type=all&pr_type='+this.type+'&sid=' + this.cookiestore.getCookie('sid');
